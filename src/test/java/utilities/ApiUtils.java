...
public class ApiUtils {
    ...
    public static Response putRequest(String token, String endpoint, Registrant1 registrant1){
        ...
        Response response = given().headers(
                ...
                ContentType.JSON,
                "Accept",
                ContentType.JSON).contentType(ContentType.JSON).body(registrant1).when().put(endpoint);
